...
- <code title="get /api/v2/parse">client.parsing.<a href="./src/llama_cloud/resources/parsing.py">list</a>(\*\*<a href="src/llama_cloud/types/parsing_list_params.py">params</a>) -> <a href="./src/llama_cloud/types/parsing_list_response.py">SyncPaginatedClassifyJobs[ParsingListResponse]</a></code>
...
- <code title="post /api/v2/parse/upload">client.parsing.<a href="./src/llama_cloud/resources/parsing.py">upload_file</a>(\*\*<a href="src/llama_cloud/types/parsing_upload_file_params.py">params</a>) -> <a href="./src/llama_cloud/types/parsing_upload_file_response.py">ParsingUploadFileResponse</a></code>

...
class TestJob:
    ...
    def test_method_retrieve(self, client: LlamaCloud) -> None:
        job = client.parsing.job.retrieve(
            "job_id",
        )
    ...
    def test_raw_response_retrieve(self, client: LlamaCloud) -> None:
        response = client.parsing.job.with_raw_response.retrieve(
            "job_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: LlamaCloud) -> None:
        with client.parsing.job.with_streaming_response.retrieve(
            "job_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: LlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.parsing.job.with_raw_response.retrieve(
                "",
            )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_parameters(self, client: LlamaCloud) -> None:
        job = client.parsing.job.get_parameters(
            "job_id",
        )
        assert_matches_type(object, job, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_parameters(self, client: LlamaCloud) -> None:
        response = client.parsing.job.with_raw_response.get_parameters(
            "job_id",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_parameters(self, client: LlamaCloud) -> None:
        with client.parsing.job.with_streaming_response.get_parameters(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_parameters(self, client: LlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.parsing.job.with_raw_response.get_parameters(
                "",
            )
...
class TestAsyncJob:
    ...
    async def test_method_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        job = await async_client.parsing.job.retrieve(
            "job_id",
        )
        assert_matches_type(ParsingJob, job, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.parsing.job.with_raw_response.retrieve(
            "job_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.parsing.job.with_streaming_response.retrieve(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.parsing.job.with_raw_response.retrieve(
                "",
            )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_parameters(self, async_client: AsyncLlamaCloud) -> None:
        job = await async_client.parsing.job.get_parameters(
            "job_id",
        )
        assert_matches_type(object, job, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_parameters(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.parsing.job.with_raw_response.get_parameters(
            "job_id",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_parameters(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.parsing.job.with_streaming_response.get_parameters(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_parameters(self, async_client: AsyncLlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.parsing.job.with_raw_response.get_parameters(
                "",
            )

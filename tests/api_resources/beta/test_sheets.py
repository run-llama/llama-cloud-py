...
class TestSheets:
    ...
    def test_method_list(self, client: LlamaCloud) -> None:
        ...
        assert_matches_type(SyncPaginatedClassifyJobs[SheetsJob], sheet, path=["response"])
...
class TestAsyncSheets:
    ...
    async def test_method_list(self, async_client: AsyncLlamaCloud) -> None:
        ...
        assert_matches_type(AsyncPaginatedClassifyJobs[SheetsJob], sheet, path=["response"])

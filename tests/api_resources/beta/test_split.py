...
class TestSplit:
    ...
    def test_method_list(self, client: LlamaCloud) -> None:
        ...
        assert_matches_type(SyncPaginatedDefault[SplitListResponse], split, path=["response"])
...
class TestAsyncSplit:
    ...
    async def test_method_list(self, async_client: AsyncLlamaCloud) -> None:
        ...
        assert_matches_type(AsyncPaginatedDefault[SplitListResponse], split, path=["response"])

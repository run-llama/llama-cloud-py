...
class TestDirectories:
    ...
    def test_method_list(self, client: LlamaCloud) -> None:
        ...
        assert_matches_type(SyncPaginatedDefaultCursor[DirectoryListResponse], directory, path=["response"])
...
class TestAsyncDirectories:
    ...
    async def test_method_list(self, async_client: AsyncLlamaCloud) -> None:
        ...
        assert_matches_type(AsyncPaginatedDefaultCursor[DirectoryListResponse], directory, path=["response"])

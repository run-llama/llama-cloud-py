...
class TestAgentData:
    ...
    def test_method_retrieve(self, client: LlamaCloud) -> None:
        agent_data = client.beta.agent_data.retrieve(
            item_id="item_id",
        )
    ...
    def test_raw_response_retrieve(self, client: LlamaCloud) -> None:
        response = client.beta.agent_data.with_raw_response.retrieve(
            item_id="item_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: LlamaCloud) -> None:
        with client.beta.agent_data.with_streaming_response.retrieve(
            item_id="item_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: LlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `item_id` but received ''"):
            client.beta.agent_data.with_raw_response.retrieve(
                item_id="",
            )
...
class TestAsyncAgentData:
    ...
    async def test_method_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        agent_data = await async_client.beta.agent_data.retrieve(
            item_id="item_id",
        )
        assert_matches_type(AgentData, agent_data, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.beta.agent_data.with_raw_response.retrieve(
            item_id="item_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.beta.agent_data.with_streaming_response.retrieve(
            item_id="item_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `item_id` but received ''"):
            await async_client.beta.agent_data.with_raw_response.retrieve(
                item_id="",
            )

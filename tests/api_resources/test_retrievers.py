...
class TestRetrievers:
    ...
    def test_path_params_retrieve(self, client: LlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `retriever_id` but received ''"):
            client.retrievers.with_raw_response.retrieve(
                retriever_id="",
            )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_retrieve_direct(self, client: LlamaCloud) -> None:
        retriever = client.retrievers.retrieve_direct(
            query="x",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_retrieve_direct_with_all_params(self, client: LlamaCloud) -> None:
        retriever = client.retrievers.retrieve_direct(
            query="x",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve_direct(self, client: LlamaCloud) -> None:
        response = client.retrievers.with_raw_response.retrieve_direct(
            query="x",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_direct(self, client: LlamaCloud) -> None:
        with client.retrievers.with_streaming_response.retrieve_direct(
            query="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncRetrievers:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `retriever_id` but received ''"):
            await async_client.retrievers.with_raw_response.retrieve(
                retriever_id="",
            )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_retrieve_direct(self, async_client: AsyncLlamaCloud) -> None:
        retriever = await async_client.retrievers.retrieve_direct(
            query="x",
        )
        assert_matches_type(CompositeRetrievalResult, retriever, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_retrieve_direct_with_all_params(self, async_client: AsyncLlamaCloud) -> None:
        retriever = await async_client.retrievers.retrieve_direct(
            query="x",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_direct(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.retrievers.with_raw_response.retrieve_direct(
            query="x",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_direct(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.retrievers.with_streaming_response.retrieve_direct(
            query="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
class TestParse:
    ...
    def test_method_upload_file(self, client: LlamacloudProd) -> None:
        parse = client.v2alpha1.parse.upload_file()
        assert_matches_type(ParsingJob, parse, path=["response"])
    ...
    def test_raw_response_upload_file(self, client: LlamacloudProd) -> None:
        response = client.v2alpha1.parse.with_raw_response.upload_file()
    ...
    def test_streaming_response_upload_file(self, client: LlamacloudProd) -> None:
        with client.v2alpha1.parse.with_streaming_response.upload_file() as response:
...
class TestAsyncParse:
    ...
    async def test_method_upload_file(self, async_client: AsyncLlamacloudProd) -> None:
        parse = await async_client.v2alpha1.parse.upload_file()
        assert_matches_type(ParsingJob, parse, path=["response"])
    ...
    async def test_raw_response_upload_file(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v2alpha1.parse.with_raw_response.upload_file()
    ...
    async def test_streaming_response_upload_file(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v2alpha1.parse.with_streaming_response.upload_file() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

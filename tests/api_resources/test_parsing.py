...
from llamacloud_prod.types.v1 import ParsingJob
...
class TestParsing:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_screenshot(self, client: LlamacloudProd) -> None:
        parsing = client.parsing.screenshot()
        assert_matches_type(ParsingJob, parsing, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_screenshot_with_all_params(self, client: LlamacloudProd) -> None:
        parsing = client.parsing.screenshot(
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_screenshot(self, client: LlamacloudProd) -> None:
        response = client.parsing.with_raw_response.screenshot()
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_screenshot(self, client: LlamacloudProd) -> None:
        with client.parsing.with_streaming_response.screenshot() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncParsing:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_screenshot(self, async_client: AsyncLlamacloudProd) -> None:
        parsing = await async_client.parsing.screenshot()
        assert_matches_type(ParsingJob, parsing, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_screenshot_with_all_params(self, async_client: AsyncLlamacloudProd) -> None:
        parsing = await async_client.parsing.screenshot(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            do_not_cache=True,
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_screenshot(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.parsing.with_raw_response.screenshot()
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_screenshot(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.parsing.with_streaming_response.screenshot() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

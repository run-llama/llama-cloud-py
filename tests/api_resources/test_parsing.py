...
class TestParsing:
    ...
    def test_method_list(self, client: LlamaCloud) -> None:
        ...
        assert_matches_type(SyncPaginatedDefault[ParsingListResponse], parsing, path=["response"])
...
class TestAsyncParsing:
    ...
    async def test_method_list(self, async_client: AsyncLlamaCloud) -> None:
        ...
        assert_matches_type(AsyncPaginatedDefault[ParsingListResponse], parsing, path=["response"])

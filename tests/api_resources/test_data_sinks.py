...
class TestDataSinks:
    ...
    def test_raw_response_upsert(self, client: LlamaCloud) -> None:
        response = client.data_sinks.with_raw_response.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    def test_streaming_response_upsert(self, client: LlamaCloud) -> None:
        with client.data_sinks.with_streaming_response.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        ) as response:
...
class TestAsyncDataSinks:
    ...
    async def test_method_upsert(self, async_client: AsyncLlamaCloud) -> None:
        data_sink = await async_client.data_sinks.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    async def test_raw_response_upsert(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.data_sinks.with_raw_response.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.data_sinks.with_streaming_response.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        ) as response:

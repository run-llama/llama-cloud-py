...
class TestFiles:
    ...
    def test_method_get(self, client: LlamaCloud) -> None:
        file = client.pipelines.files.get(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_get(self, client: LlamaCloud) -> None:
        response = client.pipelines.files.with_raw_response.get(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get(self, client: LlamaCloud) -> None:
        with client.pipelines.files.with_streaming_response.get(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: LlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `file_id` but received ''"):
            client.pipelines.files.with_raw_response.get(
                file_id="",
            )
    ...
    def test_method_query(self, client: LlamaCloud) -> None:
        file = client.pipelines.files.query()
    ...
    def test_raw_response_query(self, client: LlamaCloud) -> None:
        response = client.pipelines.files.with_raw_response.query()
    ...
    def test_streaming_response_query(self, client: LlamaCloud) -> None:
        with client.pipelines.files.with_streaming_response.query() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncFiles:
    ...
    async def test_method_get(self, async_client: AsyncLlamaCloud) -> None:
        file = await async_client.pipelines.files.get(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(PresignedURL, file, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.pipelines.files.with_raw_response.get(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.pipelines.files.with_streaming_response.get(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncLlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `file_id` but received ''"):
            await async_client.pipelines.files.with_raw_response.get(
                file_id="",
            )
    ...
    async def test_method_query(self, async_client: AsyncLlamaCloud) -> None:
        file = await async_client.pipelines.files.query()
        assert_matches_type(FileQueryResponse, file, path=["response"])
    ...
    async def test_raw_response_query(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.pipelines.files.with_raw_response.query()
    ...
    async def test_streaming_response_query(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.pipelines.files.with_streaming_response.query() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

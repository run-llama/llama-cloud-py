...
class TestJobs:
    ...
    def test_method_list(self, client: LlamaCloud) -> None:
        ...
        assert_matches_type(SyncPaginatedDefaultCursor[ClassifyJob], job, path=["response"])
...
class TestAsyncJobs:
    ...
    async def test_method_list(self, async_client: AsyncLlamaCloud) -> None:
        ...
        assert_matches_type(AsyncPaginatedDefaultCursor[ClassifyJob], job, path=["response"])

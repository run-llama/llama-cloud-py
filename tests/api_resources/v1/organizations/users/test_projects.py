...
class TestProjects:
    ...
    def test_method_create(self, client: LlamacloudProd) -> None:
        project = client.v1.organizations.users.projects.create(
            user_id="user_id",
    ...
    def test_raw_response_create(self, client: LlamacloudProd) -> None:
        response = client.v1.organizations.users.projects.with_raw_response.create(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_create(self, client: LlamacloudProd) -> None:
        with client.v1.organizations.users.projects.with_streaming_response.create(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_create(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.v1.organizations.users.projects.with_raw_response.create(
                user_id="user_id",
                organization_id="",
            )
    ...
    def test_method_list(self, client: LlamacloudProd) -> None:
        project = client.v1.organizations.users.projects.list(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_list(self, client: LlamacloudProd) -> None:
        response = client.v1.organizations.users.projects.with_raw_response.list(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: LlamacloudProd) -> None:
        with client.v1.organizations.users.projects.with_streaming_response.list(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.v1.organizations.users.projects.with_raw_response.list(
                user_id="user_id",
                organization_id="",
            )
    ...
    def test_method_delete(self, client: LlamacloudProd) -> None:
        project = client.v1.organizations.users.projects.delete(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="user_id",
        )
    ...
    def test_raw_response_delete(self, client: LlamacloudProd) -> None:
        response = client.v1.organizations.users.projects.with_raw_response.delete(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="user_id",
        )
    ...
    def test_streaming_response_delete(self, client: LlamacloudProd) -> None:
        with client.v1.organizations.users.projects.with_streaming_response.delete(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="user_id",
        ) as response:
    ...
    def test_path_params_delete(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.v1.organizations.users.projects.with_raw_response.delete(
                project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                organization_id="",
                user_id="user_id",
            )
...
class TestAsyncProjects:
    ...
    async def test_method_create(self, async_client: AsyncLlamacloudProd) -> None:
        project = await async_client.v1.organizations.users.projects.create(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(object, project, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.organizations.users.projects.with_raw_response.create(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.organizations.users.projects.with_streaming_response.create(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.v1.organizations.users.projects.with_raw_response.create(
                user_id="user_id",
                organization_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncLlamacloudProd) -> None:
        project = await async_client.v1.organizations.users.projects.list(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(ProjectListResponse, project, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.organizations.users.projects.with_raw_response.list(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.organizations.users.projects.with_streaming_response.list(
            user_id="user_id",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.v1.organizations.users.projects.with_raw_response.list(
                user_id="user_id",
                organization_id="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncLlamacloudProd) -> None:
        project = await async_client.v1.organizations.users.projects.delete(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="user_id",
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.organizations.users.projects.with_raw_response.delete(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="user_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.organizations.users.projects.with_streaming_response.delete(
            project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            user_id="user_id",
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.v1.organizations.users.projects.with_raw_response.delete(
                project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                organization_id="",
                user_id="user_id",
            )

...
class TestDataSinks:
    ...
    def test_method_create(self, client: LlamacloudProd) -> None:
        data_sink = client.v1.data_sinks.create(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    def test_raw_response_create(self, client: LlamacloudProd) -> None:
        response = client.v1.data_sinks.with_raw_response.create(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    def test_streaming_response_create(self, client: LlamacloudProd) -> None:
        with client.v1.data_sinks.with_streaming_response.create(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        ) as response:
    ...
    def test_method_retrieve(self, client: LlamacloudProd) -> None:
        data_sink = client.v1.data_sinks.retrieve(
    ...
    def test_raw_response_retrieve(self, client: LlamacloudProd) -> None:
        response = client.v1.data_sinks.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: LlamacloudProd) -> None:
        with client.v1.data_sinks.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `data_sink_id` but received ''"):
            client.v1.data_sinks.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_update(self, client: LlamacloudProd) -> None:
        data_sink = client.v1.data_sinks.update(
    ...
    def test_raw_response_update(self, client: LlamacloudProd) -> None:
        response = client.v1.data_sinks.with_raw_response.update(
            data_sink_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sink_type="PINECONE",
        )
    ...
    def test_streaming_response_update(self, client: LlamacloudProd) -> None:
        with client.v1.data_sinks.with_streaming_response.update(
            data_sink_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sink_type="PINECONE",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `data_sink_id` but received ''"):
            client.v1.data_sinks.with_raw_response.update(
                data_sink_id="",
                sink_type="PINECONE",
            )
    ...
    def test_method_list(self, client: LlamacloudProd) -> None:
        data_sink = client.v1.data_sinks.list()
    ...
    def test_raw_response_list(self, client: LlamacloudProd) -> None:
        response = client.v1.data_sinks.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: LlamacloudProd) -> None:
        with client.v1.data_sinks.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: LlamacloudProd) -> None:
        data_sink = client.v1.data_sinks.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_delete(self, client: LlamacloudProd) -> None:
        response = client.v1.data_sinks.with_raw_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_delete(self, client: LlamacloudProd) -> None:
        with client.v1.data_sinks.with_streaming_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `data_sink_id` but received ''"):
            client.v1.data_sinks.with_raw_response.delete(
                "",
            )
    ...
    def test_method_upsert(self, client: LlamacloudProd) -> None:
        data_sink = client.v1.data_sinks.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    def test_raw_response_upsert(self, client: LlamacloudProd) -> None:
        response = client.v1.data_sinks.with_raw_response.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    def test_streaming_response_upsert(self, client: LlamacloudProd) -> None:
        with client.v1.data_sinks.with_streaming_response.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        ) as response:
...
class TestAsyncDataSinks:
    ...
    async def test_method_create(self, async_client: AsyncLlamacloudProd) -> None:
        data_sink = await async_client.v1.data_sinks.create(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.data_sinks.with_raw_response.create(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.data_sinks.with_streaming_response.create(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        ) as response:
    ...
    async def test_method_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        data_sink = await async_client.v1.data_sinks.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(DataSink, data_sink, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.data_sinks.with_raw_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.data_sinks.with_streaming_response.retrieve(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `data_sink_id` but received ''"):
            await async_client.v1.data_sinks.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncLlamacloudProd) -> None:
        data_sink = await async_client.v1.data_sinks.update(
            data_sink_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sink_type="PINECONE",
        )
        assert_matches_type(DataSink, data_sink, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.data_sinks.with_raw_response.update(
            data_sink_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sink_type="PINECONE",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.data_sinks.with_streaming_response.update(
            data_sink_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            sink_type="PINECONE",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `data_sink_id` but received ''"):
            await async_client.v1.data_sinks.with_raw_response.update(
                data_sink_id="",
                sink_type="PINECONE",
            )
    ...
    async def test_method_list(self, async_client: AsyncLlamacloudProd) -> None:
        data_sink = await async_client.v1.data_sinks.list()
        assert_matches_type(DataSinkListResponse, data_sink, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.data_sinks.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.data_sinks.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncLlamacloudProd) -> None:
        data_sink = await async_client.v1.data_sinks.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert data_sink is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.data_sinks.with_raw_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.data_sinks.with_streaming_response.delete(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `data_sink_id` but received ''"):
            await async_client.v1.data_sinks.with_raw_response.delete(
                "",
            )
    ...
    async def test_method_upsert(self, async_client: AsyncLlamacloudProd) -> None:
        data_sink = await async_client.v1.data_sinks.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    async def test_raw_response_upsert(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.data_sinks.with_raw_response.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        )
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.data_sinks.with_streaming_response.upsert(
            component={"foo": "bar"},
            name="name",
            sink_type="PINECONE",
        ) as response:

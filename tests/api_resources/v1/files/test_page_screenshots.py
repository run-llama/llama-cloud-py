...
class TestPageScreenshots:
    ...
    def test_method_retrieve(self, client: LlamacloudProd) -> None:
        page_screenshot = client.v1.files.page_screenshots.retrieve(
            page_index=0,
    ...
    def test_raw_response_retrieve(self, client: LlamacloudProd) -> None:
        response = client.v1.files.page_screenshots.with_raw_response.retrieve(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_retrieve(self, client: LlamacloudProd) -> None:
        with client.v1.files.page_screenshots.with_streaming_response.retrieve(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.v1.files.page_screenshots.with_raw_response.retrieve(
                page_index=0,
                id="",
            )
    ...
    def test_method_list(self, client: LlamacloudProd) -> None:
        page_screenshot = client.v1.files.page_screenshots.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_list(self, client: LlamacloudProd) -> None:
        response = client.v1.files.page_screenshots.with_raw_response.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: LlamacloudProd) -> None:
        with client.v1.files.page_screenshots.with_streaming_response.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.v1.files.page_screenshots.with_raw_response.list(
                id="",
            )
    ...
    def test_method_generate_presigned_url(self, client: LlamacloudProd) -> None:
        page_screenshot = client.v1.files.page_screenshots.generate_presigned_url(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_generate_presigned_url(self, client: LlamacloudProd) -> None:
        response = client.v1.files.page_screenshots.with_raw_response.generate_presigned_url(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_generate_presigned_url(self, client: LlamacloudProd) -> None:
        with client.v1.files.page_screenshots.with_streaming_response.generate_presigned_url(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_generate_presigned_url(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.v1.files.page_screenshots.with_raw_response.generate_presigned_url(
                page_index=0,
                id="",
            )
...
class TestAsyncPageScreenshots:
    ...
    async def test_method_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        page_screenshot = await async_client.v1.files.page_screenshots.retrieve(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(object, page_screenshot, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.files.page_screenshots.with_raw_response.retrieve(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.files.page_screenshots.with_streaming_response.retrieve(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.v1.files.page_screenshots.with_raw_response.retrieve(
                page_index=0,
                id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncLlamacloudProd) -> None:
        page_screenshot = await async_client.v1.files.page_screenshots.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(PageScreenshotListResponse, page_screenshot, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.files.page_screenshots.with_raw_response.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.files.page_screenshots.with_streaming_response.list(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.v1.files.page_screenshots.with_raw_response.list(
                id="",
            )
    ...
    async def test_method_generate_presigned_url(self, async_client: AsyncLlamacloudProd) -> None:
        page_screenshot = await async_client.v1.files.page_screenshots.generate_presigned_url(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(PresignedURL, page_screenshot, path=["response"])
    ...
    async def test_raw_response_generate_presigned_url(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.files.page_screenshots.with_raw_response.generate_presigned_url(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_generate_presigned_url(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.files.page_screenshots.with_streaming_response.generate_presigned_url(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_generate_presigned_url(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.v1.files.page_screenshots.with_raw_response.generate_presigned_url(
                page_index=0,
                id="",
            )

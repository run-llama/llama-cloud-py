...
class TestBilling:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_downgrade_plan(self, client: LlamacloudProd) -> None:
        billing = client.v1.billing.downgrade_plan(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_downgrade_plan(self, client: LlamacloudProd) -> None:
        response = client.v1.billing.with_raw_response.downgrade_plan(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_downgrade_plan(self, client: LlamacloudProd) -> None:
        with client.v1.billing.with_streaming_response.downgrade_plan(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncBilling:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_create_intent_and_customer_session(
        self, async_client: AsyncLlamacloudProd
    ) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_downgrade_plan(self, async_client: AsyncLlamacloudProd) -> None:
        billing = await async_client.v1.billing.downgrade_plan(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(BillingDowngradePlanResponse, billing, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_downgrade_plan(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.billing.with_raw_response.downgrade_plan(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_downgrade_plan(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.billing.with_streaming_response.downgrade_plan(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

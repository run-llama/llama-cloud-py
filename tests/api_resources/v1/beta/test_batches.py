...
class TestBatches:
    ...
    def test_method_create(self, client: LlamacloudProd) -> None:
        batch = client.v1.beta.batches.create(
    ...
    def test_raw_response_create(self, client: LlamacloudProd) -> None:
        response = client.v1.beta.batches.with_raw_response.create(
            external_id="external_id",
            input_id="input_id",
            input_type="input_type",
            body_project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    def test_streaming_response_create(self, client: LlamacloudProd) -> None:
        with client.v1.beta.batches.with_streaming_response.create(
            external_id="external_id",
            input_id="input_id",
            input_type="input_type",
            body_project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    def test_method_retrieve(self, client: LlamacloudProd) -> None:
        batch = client.v1.beta.batches.retrieve(
            batch_id="batch_id",
        )
    ...
    def test_raw_response_retrieve(self, client: LlamacloudProd) -> None:
        response = client.v1.beta.batches.with_raw_response.retrieve(
            batch_id="batch_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: LlamacloudProd) -> None:
        with client.v1.beta.batches.with_streaming_response.retrieve(
            batch_id="batch_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: LlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `batch_id` but received ''"):
            client.v1.beta.batches.with_raw_response.retrieve(
                batch_id="",
            )
    ...
    def test_method_list(self, client: LlamacloudProd) -> None:
        batch = client.v1.beta.batches.list()
    ...
    def test_raw_response_list(self, client: LlamacloudProd) -> None:
        response = client.v1.beta.batches.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: LlamacloudProd) -> None:
        with client.v1.beta.batches.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncBatches:
    ...
    async def test_method_create(self, async_client: AsyncLlamacloudProd) -> None:
        batch = await async_client.v1.beta.batches.create(
            external_id="external_id",
            input_id="input_id",
            input_type="input_type",
            body_project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    async def test_raw_response_create(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.beta.batches.with_raw_response.create(
            external_id="external_id",
            input_id="input_id",
            input_type="input_type",
            body_project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    async def test_streaming_response_create(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.beta.batches.with_streaming_response.create(
            external_id="external_id",
            input_id="input_id",
            input_type="input_type",
            body_project_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    async def test_method_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        batch = await async_client.v1.beta.batches.retrieve(
            batch_id="batch_id",
        )
        assert_matches_type(BatchRetrieveResponse, batch, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.beta.batches.with_raw_response.retrieve(
            batch_id="batch_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.beta.batches.with_streaming_response.retrieve(
            batch_id="batch_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLlamacloudProd) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `batch_id` but received ''"):
            await async_client.v1.beta.batches.with_raw_response.retrieve(
                batch_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncLlamacloudProd) -> None:
        batch = await async_client.v1.beta.batches.list()
        assert_matches_type(BatchListResponse, batch, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncLlamacloudProd) -> None:
        response = await async_client.v1.beta.batches.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncLlamacloudProd) -> None:
        async with async_client.v1.beta.batches.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

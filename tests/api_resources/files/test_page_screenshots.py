...
class TestPageScreenshots:
    ...
    def test_method_get(self, client: LlamaCloud) -> None:
        page_screenshot = client.files.page_screenshots.get(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_get(self, client: LlamaCloud) -> None:
        response = client.files.page_screenshots.with_raw_response.get(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get(self, client: LlamaCloud) -> None:
        with client.files.page_screenshots.with_streaming_response.get(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_get(self, client: LlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.files.page_screenshots.with_raw_response.get(
                page_index=0,
                id="",
            )
...
class TestAsyncPageScreenshots:
    ...
    async def test_method_get(self, async_client: AsyncLlamaCloud) -> None:
        page_screenshot = await async_client.files.page_screenshots.get(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(object, page_screenshot, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncLlamaCloud) -> None:
        response = await async_client.files.page_screenshots.with_raw_response.get(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncLlamaCloud) -> None:
        async with async_client.files.page_screenshots.with_streaming_response.get(
            page_index=0,
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get(self, async_client: AsyncLlamaCloud) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.files.page_screenshots.with_raw_response.get(
                page_index=0,
                id="",
            )

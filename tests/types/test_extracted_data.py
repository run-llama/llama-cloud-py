...
# =============================================================================
# V2 ExtractV2Job helpers and tests
# =============================================================================
...
def _make_v2_job(
    ...
    return model_parse(
        ExtractV2Job,
        {
            ...
            # V2 field (used by from_extract_job)
            "document_input_value": document_input_value,
            # V1 fields still required on next branch; will be removed by Stainless codegen
            "type": "file_id",
            "value": document_input_value,
            "parameters": {},
        },
    )
...
def test_from_extract_job_invalid_data():
    ...
    assert invalid_data.file_id == "dfl-test-file-id"

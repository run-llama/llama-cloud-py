...
from ......types.v1.beta.spreadsheet import (
    job_list_params,
    job_create_params,
    job_retrieve_params,
)
from ......types.v1.beta.spreadsheet.spreadsheet_job import SpreadsheetJob
from ......types.v1.beta.spreadsheet.job_list_response import JobListResponse
from ......types.v1.beta.spreadsheet.spreadsheet_parsing_config_param import SpreadsheetParsingConfigParam
...
class JobsResourceWithRawResponse:
    ...
    def tables(self) -> TablesResourceWithRawResponse:
        return TablesResourceWithRawResponse(self._jobs.tables)
...
class AsyncJobsResourceWithRawResponse:
    ...
    def tables(self) -> AsyncTablesResourceWithRawResponse:
        return AsyncTablesResourceWithRawResponse(self._jobs.tables)
...
class JobsResourceWithStreamingResponse:
    ...
    def tables(self) -> TablesResourceWithStreamingResponse:
        return TablesResourceWithStreamingResponse(self._jobs.tables)
...
class AsyncJobsResourceWithStreamingResponse:
    ...
    def tables(self) -> AsyncTablesResourceWithStreamingResponse:
        return AsyncTablesResourceWithStreamingResponse(self._jobs.tables)

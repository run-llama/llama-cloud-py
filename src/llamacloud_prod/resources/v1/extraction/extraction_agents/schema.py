...
from .....types.v1.extraction.extraction_agents import schema_generate_params, schema_validation_params
from .....types.v1.extraction.extraction_agents.schema_generate_response import SchemaGenerateResponse
from .....types.v1.extraction.extraction_agents.schema_validation_response import SchemaValidationResponse
    ...
    def generate(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=SchemaGenerateResponse,
        )
    ...
    def validation(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"data_schema": data_schema}, schema_validation_params.SchemaValidationParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=SchemaValidationResponse,
        )
    ...
    async def validation(
        ...
        *,
        ...
        return await self._post(
            "/api/v1/extraction/extraction-agents/schema/validation",
            body=await async_maybe_transform(
                {"data_schema": data_schema}, schema_validation_params.SchemaValidationParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),

...
from ...types import parsing_screenshot_params, parsing_upload_file_params
from .job.job import (
    JobResource,
    AsyncJobResource,
...
from ...types.v1 import ParsingMode, FailPageMode
...
from ...types.v1.parsing_job import ParsingJob
from ...types.v1.parsing_mode import ParsingMode
from ...types.v1.fail_page_mode import FailPageMode
from ...types.v1.parser_languages import ParserLanguages
    ...
    def screenshot(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(body, parsing_screenshot_params.ParsingScreenshotParams),
            files=files,
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    parsing_screenshot_params.ParsingScreenshotParams,
                ),
            ),
            cast_to=ParsingJob,
        )
    ...
    async def screenshot(
        ...
        *,
        ...
        return await self._post(
            "/api/parsing/screenshot",
            body=await async_maybe_transform(body, parsing_screenshot_params.ParsingScreenshotParams),
            files=files,
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,

...
__all__ = [
    ...
    "AzureOpenAIEmbeddingConfigComponent",
    "CohereEmbeddingConfig",
    "CohereEmbeddingConfigComponent",
    "GeminiEmbeddingConfig",
    "GeminiEmbeddingConfigComponent",
    "HuggingFaceInferenceAPIEmbeddingConfig",
    "HuggingFaceInferenceAPIEmbeddingConfigComponent",
    "OpenAIEmbeddingConfig",
    "OpenAIEmbeddingConfigComponent",
    "VertexAIEmbeddingConfig",
    "VertexAIEmbeddingConfigComponent",
    "BedrockEmbeddingConfig",
    "BedrockEmbeddingConfigComponent",
]
...
class AzureOpenAIEmbeddingConfig(TypedDict, total=False):
    ...
    component: AzureOpenAIEmbeddingConfigComponent
...
class AzureOpenAIEmbeddingConfigComponent(TypedDict, total=False):
...
class CohereEmbeddingConfig(TypedDict, total=False):
    pipeline_id: Optional[str]

    component: CohereEmbeddingConfigComponent
...
class CohereEmbeddingConfigComponent(TypedDict, total=False):
...
class GeminiEmbeddingConfig(TypedDict, total=False):
    pipeline_id: Optional[str]

    component: GeminiEmbeddingConfigComponent
...
class GeminiEmbeddingConfigComponent(TypedDict, total=False):
...
class HuggingFaceInferenceAPIEmbeddingConfig(TypedDict, total=False):
    pipeline_id: Optional[str]

    component: HuggingFaceInferenceAPIEmbeddingConfigComponent
...
class HuggingFaceInferenceAPIEmbeddingConfigComponent(TypedDict, total=False):
...
class OpenAIEmbeddingConfig(TypedDict, total=False):
    pipeline_id: Optional[str]

    component: OpenAIEmbeddingConfigComponent
...
class OpenAIEmbeddingConfigComponent(TypedDict, total=False):
    additional_kwargs: Dict[str, object]
    """Additional kwargs for the OpenAI API."""
...
class VertexAIEmbeddingConfig(TypedDict, total=False):
    pipeline_id: Optional[str]

    component: VertexAIEmbeddingConfigComponent
...
class VertexAIEmbeddingConfigComponent(TypedDict, total=False):
...
class BedrockEmbeddingConfig(TypedDict, total=False):
    ...
    component: BedrockEmbeddingConfigComponent
...
class BedrockEmbeddingConfigComponent(TypedDict, total=False):
    additional_kwargs: Dict[str, object]
...
ValidateIntegrationValidateEmbeddingConnectionParams: TypeAlias = Union[
    AzureOpenAIEmbeddingConfig,
    CohereEmbeddingConfig,
    GeminiEmbeddingConfig,
    HuggingFaceInferenceAPIEmbeddingConfig,

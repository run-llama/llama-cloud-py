...
__all__ = ["ValidateIntegrationValidateDataSourceConnectionParams", "Component"]


class ValidateIntegrationValidateDataSourceConnectionParams(TypedDict, total=False):
    ...
    existing_data_source_id: Optional[str]

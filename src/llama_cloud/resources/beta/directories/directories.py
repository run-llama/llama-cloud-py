...
class DirectoriesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> SyncPaginatedDefaultCursor[DirectoryListResponse]:
        """
        List Directories
        ...
        return self._get_api_list(
            "/api/v1/beta/directories",
            page=SyncPaginatedDefaultCursor[DirectoryListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
...
class AsyncDirectoriesResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[DirectoryListResponse, AsyncPaginatedDefaultCursor[DirectoryListResponse]]:
        """
        List Directories
        ...
        return self._get_api_list(
            "/api/v1/beta/directories",
            page=AsyncPaginatedDefaultCursor[DirectoryListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,

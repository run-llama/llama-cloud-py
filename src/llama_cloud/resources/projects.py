...
from ..types import (
    ...
    project_upsert_params,
    project_retrieve_params,
    project_get_usage_params,
    project_get_current_params,
)
...
class ProjectsResource(SyncAPIResource):
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"organization_id": organization_id}, project_retrieve_params.ProjectRetrieveParams
                ),
            ),
            cast_to=Project,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    project_get_current_params.ProjectGetCurrentParams,
                ),
            ),
            cast_to=Project,
        )
    ...
    def upsert(
        ...
        *,
        ...
        Updates if a project with the same name already exists.
        ...
        return self._put(
            "/api/v1/projects",
            body=maybe_transform({"name": name}, project_upsert_params.ProjectUpsertParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"organization_id": organization_id}, project_upsert_params.ProjectUpsertParams),
            ),
            cast_to=Project,
        )
...
class AsyncProjectsResource(AsyncAPIResource):
    ...
    async def upsert(
        ...
        *,
        ...
        return await self._put(
            "/api/v1/projects",
            body=await async_maybe_transform({"name": name}, project_upsert_params.ProjectUpsertParams),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform(
                    {"organization_id": organization_id}, project_upsert_params.ProjectUpsertParams
                ),
            ),
            cast_to=Project,
        )
